...
<div class="w3-top">
  <ul class="w3-navbar w3-theme w3-top w3-left-align w3-large">
    ...
    <li class="w3-hide-small"><a href="#" class="w3-hover-white">Details</a></li>
    <li class="w3-hide-small"><a href="#" class="w3-hover-white">Routes</a></li>
    <li class="w3-hide-small"><a href="#" class="w3-hover-white">Vehicles</a></li>
  </ul>
</div>
...
<nav class="w3-sidenav w3-collapse w3-theme-l5 w3-animate-left" style="z-index:3;width:250px;margin-top:51px;" id="mySidenav">
  ...
  <h4><b>Menu</b></h4>
  <a href="#" class="w3-hover-black">Details</a>
  <a href="#" class="w3-hover-black">Routes</a>
  <a href="#" class="w3-hover-black">Vehicles</a>
</nav>
