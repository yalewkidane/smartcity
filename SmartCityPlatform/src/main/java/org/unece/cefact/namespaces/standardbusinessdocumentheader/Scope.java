...
/**
 * <p>Scope complex type에 대한 Java 클래스입니다.
 * 
    ...
    implements Serializable
{
    ...
    protected List<JAXBElement<?>> scopeInformations;
     ...
     * This is why there is not a <CODE>set</CODE> method for the scopeInformations property.
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<?>> getScopeInformations() {
        if (scopeInformations == null) {
            scopeInformations = new ArrayList<JAXBElement<?>>();
        }
        return this.scopeInformations;
    }
