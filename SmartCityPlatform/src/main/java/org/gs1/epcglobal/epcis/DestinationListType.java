...
/**
 * <p>DestinationListType complex type에 대한 Java 클래스입니다.
 * 
    ...
    implements Serializable
{
    ...
    protected List<SourceDestType> destinations;
     ...
     * 
     */
    public List<SourceDestType> getDestinations() {
        if (destinations == null) {
            destinations = new ArrayList<SourceDestType>();
        }
