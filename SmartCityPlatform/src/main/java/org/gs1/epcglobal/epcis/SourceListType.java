...
/**
 * <p>SourceListType complex type에 대한 Java 클래스입니다.
 * 
    ...
    implements Serializable
{
    ...
    protected List<SourceDestType> sources;
     ...
     * 
     */
    public List<SourceDestType> getSources() {
        if (sources == null) {
            sources = new ArrayList<SourceDestType>();
        }
        return this.sources;
    }
