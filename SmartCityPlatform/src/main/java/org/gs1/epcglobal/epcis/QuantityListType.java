...
/**
 * <p>QuantityListType complex type에 대한 Java 클래스입니다.
 * 
    ...
    implements Serializable
{
    ...
    protected List<QuantityElementType> quantityElements;

    /**
     * Gets the value of the quantityElements property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the quantityElements property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getQuantityElements().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<QuantityElementType> getQuantityElements() {
        if (quantityElements == null) {
            quantityElements = new ArrayList<QuantityElementType>();
        }
